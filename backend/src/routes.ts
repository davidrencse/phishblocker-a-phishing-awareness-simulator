...
const routeDefinitions: RouteDefinition[] = [
  {
    "method": "post",
    "path": "/auth/register",
    "purpose": "Create a new user account and start an authenticated session.",
    "response_shape": {
      "success": "boolean",
      "data": {
        "user": "PublicUser"
  ...
  },
  {
    "method": "post",
    "path": "/auth/login",
    "purpose": "Authenticate an existing user and start an authenticated session.",
    "response_shape": {
      "success": "boolean",
      "data": {
        "user": "PublicUser"
  ...
  },
  {
    "method": "get",
    "path": "/auth/session",
    "purpose": "Return the current authenticated user if a valid session exists.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    "method": "get",
    "path": "/scenarios",
    "purpose": "Return a filtered list of simulated email scenarios available to the authenticated user.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    ...
    "purpose": "Return full simulated email content and available red-flag options for a scenario.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  {
    "method": "post",
    "path": "/scenarios/:scenarioId/attempts",
    "purpose": "Submit a user's classification and selected red flags for scoring.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    ...
    "purpose": "Return detailed feedback for a previously submitted attempt owned by the authenticated user.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    ...
    "purpose": "Return aggregate user performance metrics for the dashboard.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    ...
    "purpose": "Return recent scenario attempts for the authenticated user.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    "method": "get",
    "path": "/resources",
    "purpose": "Return educational phishing awareness resources.",
    "response_shape": {
      "success": "boolean",
      "data": {
  ...
  },
  {
    "method": "get",
    "path": "/health",
    "purpose": "Return service health status for development and deployment checks.",
    "response_shape": {
      "success": "boolean",
      "data": {
        "status": "ok",
